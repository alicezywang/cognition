#include "detection_cognition_plugin/test_plugin.h"
#include <pluginlib/class_list_macros.h>

PLUGINLIB_EXPORT_CLASS(observe_softbus::DetectionCognTest, general_bus::GeneralPlugin);
using namespace observe_softbus;
using namespace std;

/*******************************
 * classs DetectionCognTest
 *******************************/
DetectionCognTest::DetectionCognTest()
{
    ROS_INFO("staring DetectionCognTest Plugin ......");
}
DetectionCognTest::~DetectionCognTest(){
    ROS_INFO("DetectionCognTest plugin had closed!");
}

void DetectionCognTest::start()
{
    ...
    //ROS
    sub_img = pluginSubscribe("/recogImage", 1, &DetectionCognTest::imgCallBack, this);
...
void DetectionCognTest::imgCallBack(const sensor_msgs::Image::ConstPtr& msg){
    ...
    if(flag){
      ...
      pub_test.publish(ml_detection.img_result);
        ...
        ROS_INFO("~~~~~~~~ GeneralPlugin/DetectionCognTest : Detection Call Timeout ~~~~~~~~");
    }
}
