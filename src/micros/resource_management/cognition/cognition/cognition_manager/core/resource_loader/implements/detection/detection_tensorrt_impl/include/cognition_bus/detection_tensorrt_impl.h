#ifndef CognitionDetectionTensorRTImpl_H
#define CognitionDetectionTensorRTImpl_H
...
/**
 * @brief The DetectionTensorRTImpl class of image target detection task
 */
class DetectionTensorRTImpl final : public SoftBusDetection{
public:
    DetectionTensorRTImpl();
    /**
...
#endif // CognitionDetectionTensorRTImpl_H
